...
const page = usePage();
const props = defineProps(['challengeInfo', 'zones','deadline','formatDate']);
const form = useForm({
    team_name: '',
    team_member: '',
    team_leader_name: '',
            ...
            <div class="container">
                <div class="row">
                    <div v-if="page.props.app_id" class="alert alert-success alert-dismissible fade show text-center" role="alert">
                        ...
                        <p class="text-center">You can now log in to your participant portal using the credentials sent to team leader email.</p>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <form @submit.prevent="submit" class="border border-dark-subtle shadow mt-2 mb-4 pb-4">
                            <div class="application-form-header bg-navy-700 px-3 py-4">
                                <div class="row">
                                    <div class="col-12">
                                ...
                                <div class="col-12 col-lg-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select shadow-none" id="location" :class="{'is-invalid':form.errors.location}" v-model="form.location" aria-label="Default select example">
                                            ...
                                            <option v-for="zone in props.zones" :value="zone.id" :key="zone.id" v-text="zone.title"></option>
                                        </select>
                                ...
                                <div class="col-12 col-lg-4">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" accept="image/png, image/jpg, image/jpeg"
                                               :class="{'is-invalid':form.errors.image}" type="file"
