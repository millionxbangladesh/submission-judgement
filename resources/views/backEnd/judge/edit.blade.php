            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col mb-3">
                        ...
                        <div>
                            <textarea id="summernote" name="description">{{ $judge['description'] }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="col mb-3">
                ...
                <div class="row g-2">
                    <div class="col mb-0">
                        ...
                        <input class="form-control" value="{{ $judge['fb'] }}" type="text" id="fb"
                            placeholder="Enter Facebook Link" name="fb"  />
                    </div>
                    <div class="col mb-0">
                        <label for="linkedin" class="form-label">Linkedin<span
                                class="text-danger">*</span></label>
                        <input type="text" id="linkedin" value="{{ $judge['linkedin'] }}"
                            class="form-control" name="linkedin" placeholder="Enter Linkedin Link" required />
                    </div>
                    <div class="col mb-0">
                        <label for="twitter" class="form-label">Twitter</label>
                        <input type="text" id="twitter" value="{{ $judge['twitter'] }}"
                ...
                <div class="row g-2">
                    <div class="col mb-0">
                        ...
                        <input class="form-control" type="number" value="{{ $judge['mobile'] }}"
                            id="mobile" placeholder="Enter Mobile number" name="mobile"  />
                    </div>
                    <div class="col mb-0">
                        <label for="email" class="form-label">Email</label>
                        <input type="email" id="email" class="form-control" value="{{ $judge['email'] }}"
                            name="email" placeholder="Enter Email"  />
                        <input type="text" id="Organizer_id" value="{{ $id }}" name="Organizer_id"
                            hidden />
                    </div>
                </div>
            </div>
            <img id="preview_AlbumImage_image" alt="Preview" class="image-preview-resize" hidden>
            <img id="load_AlbumImage_image" src="{{asset('uploads/organizer/'.$judge['image'])}}" alt="Preview" class="image-preview-resize" >
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                input.addEventListener('change', function(e) {
                    ...
                    var image_hide = document.getElementById('load_AlbumImage_image');
                    image_hide.setAttribute("hidden", "");
