<x-app-layout>
    ...
    <x-breadcrumb>
        <x-slot:section>Sponsor</x-slot:section>
            ...
            <div class="modal-body">
                    ...
                    <div class="float-end">
                        <div class="form-check form-switch float-end">
                            <input name="status" class="form-check-input" type="checkbox" value="active"
                                @if ($sponsor['status'] == 'active') checked @endif />
                            <label class="form-check-label">Active</label>
                        </div>
                    </div>
                    <div class="col mb-2">
                        <label for="question" class="form-label">TITLE </label>
                        <input name="title" value="{{ $sponsor['title'] }}" type="text" id="title" class="form-control" placeholder="Enter Title"
                             />
                    </div>
                    <div class="col mb-0">
                        ...
                        <div class="input-group">
                            ...
                            <img id="preview_AlbumImage_image" alt="Preview" class="image-resize rounded-end" src="{{ asset($sponsor['image']) }}" @if(empty($sponsor['image'])) hidden @endif>
                        </div>
                    </div>
                </div>
                <div class="row g-2 mt-2">
                    <div class="col mb-0">
                        ...
                        <div class="input-group">
                            <input name="url" value="{{ $sponsor['url'] }}" class="form-control" type="url" placeholder="Enter Url" />
                        </div>
                    </div>
                </div>
            </div>
            <input name="id" value="{{ $sponsor['id'] }}" hidden/>
