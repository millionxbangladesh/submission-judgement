        ...
        <div class="container">
            <div class="card-header">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                    ...
                    {{-- Filter Form --}}
                    <form action="{{ route('judge.index') }}" method="GET" class="d-flex flex-column flex-sm-row gap-2">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('judge.index') }}" class="btn btn-outline-secondary">
                        ...
                        @foreach ($projects as $key=>$project )
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if(judgeOwnMarks($project->id) !== null)
                                        <span class="badge bg-label-primary"> Marked {{ judgeOwnMarks($project->id) }}</span>
                                    @endif
                                </td>
                                <td>
                                    <a title="Edit Room" target="_bnalk" href="{{ route('judge.view',[ 'id' => $project->id ]) }}" class="btn btn-primary btn-sm"><i class="bx bx-show"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
