                ...
                <div class="card-body">
                  ...
                  <span class="app-brand-logo demo">
                   <img src="{{asset('/assets/logo.png')}}" alt="" style="height: 80px">
                    ...
                    <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('login') }}">@csrf
                        <div class="mb-3">
                            <x-form.input-label for="email" :value="__('Email')" />
                            <x-form.input-text id="email" class="form-control" :class="$errors->has('email')?'is-invalid':''" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
